...
// eslint-disable-next-line es/no-object-setprototypeof -- safe
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _controls, _adsInstance, _uid, _element, _ads, _media, _events, _autoplay_1, _volume, _canAutoplay,
                _canAutoplayMuted, _processedAutoplay, _options, _customControlItems, _defaultOptions;
                ...
                function Player(element, options) {
                    ...
                    _defaultOptions.set(this, {
                        ...
                        labels: {
                            ...
                            levels: 'Video Quality',
                            audioLevels: 'Audio Quality',
                            live: 'Live Broadcast',
                ...
                _createClass(Player, [{
                    ...
                    value: function _createPlayButton() {
                        ...
                        this.playBtn.addEventListener('click', function () {
                            if (!locationSearch.get('ticket')) {
                                // console.log("!alwaysVisible && !constants_1.IS_ANDROID && !constants_1.IS_IOS", !alwaysVisible , !constants_1.IS_ANDROID , !constants_1.IS_IOS)
...
//# sourceMappingURL=index.mjs.map
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var audio_levels_1 = __importDefault(__webpack_require__(150));
            ...
            var Controls = function () {
                function Controls(player) {
                    ...
                    _controlEls.set(this, {
                        ...
                        Play: play_1["default"],
                        AudioLevels: audio_levels_1["default"],
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _player, _button, _captions, _menu, _events, _tracks, _trackList, _trackUrlList, _hasTracks,
                _current, _default, _detachMenu, _labels, _position, _layer;
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _player, _isFullscreen, _button, _fullscreenEvents, _fullscreenWidth, _fullscreenHeight,
                _clickEvent, _labels, _position, _layer;
                    ...
                    value: function _gatherLevels() {
                        ...
                        if (!__classPrivateFieldGet(this, _levels).length) {
                            __classPrivateFieldGet(this, _player).getMedia().levels.forEach(function (level) {
                                if (level['label'] && !level['label'].startsWith('audio ')) {
                    ...
                    value: function create() {
                        ...
                        __classPrivateFieldGet(this, _events).media.click = function (e) {
                            ...
                            if (el.paused || el.ended) {
                                ...
                                // op-player op-player__keyboard--inactive op-player__video op-controls--hidden
                                // console.log("!constants_1.IS_ANDROID && !constants_1.IS_IOS", !constants_1.IS_ANDROID && !constants_1.IS_IOS, document.getElementsByrClassName())
                                // if (!constants_1.IS_ANDROID && !constants_1.IS_IOS)
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _player, _progress, _slider, _buffer, _played, _tooltip, _events, _forcePause, _labels, _position,
                _layer;
            ...
            var Progress = function () {
                ...
                _createClass(Progress, [{
                    ...
                    value: function create() {
                        ...
                        __classPrivateFieldGet(this, _progress).id = 'newid-seekbar';
                ...
                _createClass(Settings, [{
                    ...
                    value: function create() {
                        ...
                        this.clickEvent = function () {
                            ...
                            // this.element.dispatchEvent('clickOnSetting');
                            // let participantElement = document.getElementsByClassName('op-participants');
                            // if(participantElement && participantElement.length){
                            //     participantElement[0].style.display = 'none'
                            // }
                    ...
                    value: function addItem(name, key, defaultValue, submenu, className) {
                        ...
                        menuItem.className = 'op-settings__menu-item openplayer-item-'+key;
                        menuItem.tabIndex = 0;
                        ...
                        __classPrivateFieldGet(this, _events).global['settings.submenu'] = function (e) {
                            ...
                            if (target.closest("#".concat(__classPrivateFieldGet(_this3, _player).id))) {
                                if (general_1.hasClass(target, 'op-settings__back')) {
                                    ...
                                    if (menuTarget) {
                                        var levels = target.parentElement.parentElement.querySelectorAll('.op-settings__submenu-item');
                                        for (var i = 0, total = levels.length; i < total; ++i) {
                                            levels[i].setAttribute('aria-checked', 'false');
                                        }
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _element, _media, _files, _promisePlay, _options, _autoplay, _mediaLoaded, _customMedia,
                _currentSrc;
            ...
            function get_browser_info() {
                ...
                if (M.length && M[0] === 'Netscape') {
                    if (M[1].includes('iPhone') || M[1].includes('iPad')) {
                        let data = M[1];
                        M = [];
                        M.push('Safari');
                        M.push(data.substr(data.indexOf('OS') + 2, 7).trim().split('_')[0]);
                    }
                }
                if (M[0] === 'Safari' && isMobile) {
                    device = 'iPhone';
                } else if (M[0] !== 'Safari' && isMobile) {
                    device = 'Android';
                }
            ...
            setTimeout(() => {
                let videoInfo = document.getElementById("video-info-id");
                if (videoInfo) {
                    videoInfo.addEventListener('closeMovieInfo', function (e) {
                        pausedPlayer = 0;
                    }, false);
                }
                ...
                _createClass(Media, [{
                    ...
                    value: function pause() {
                        ...
                        if (pausedPlayer === 2) {
                            ...
                            pausedPlayer = 0;
                        } else if (browserInfo && browserInfo.device === 'pc') {
                            if (__classPrivateFieldGet(this, _promisePlay) !== undefined) {
                                __classPrivateFieldGet(this, _promisePlay).then(function () {
                                    __classPrivateFieldGet(_this3, _media).pause();
                                });
                    ...
                    get: function get() {
                        return __classPrivateFieldGet(this, _media) ? __classPrivateFieldGet(this, _media).audioLevel : -1;
                    }
                }, {
                    key: "audioLevels",
                    get: function get() {
                        return __classPrivateFieldGet(this, _media) ? __classPrivateFieldGet(this, _media).audioLevels : [];
                    }
                }, {
                    key: "instance",
                    get: function get() {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var DashMedia = function (_native_1$default) {
                ...
                function DashMedia(element, mediaSource, options) {
                    ...
                    _this.promise = typeof dashjs === 'undefined' ? general_1.loadScript('../assets/openplayer/dash.all.min.js') : new Promise(function (resolve) {
                        resolve({});
                    });
                ...
                _createClass(DashMedia, [{
                    ...
                    get: function get() {
                        ...
                        if (__classPrivateFieldGet(this, _player)) {
                            ...
                            var bitratesAudio = __classPrivateFieldGet(this, _player).getBitrateInfoListFor('audio');
                            if (bitrates.length) {
                                bitrates.forEach(function (item, index) {
                                    if (item) {
                                        var _bitrates$item = item,
                            ...
                            if (bitratesAudio.length) {
                                bitratesAudio.forEach(function (item, index) {
                                    if (item) {
                                        var _bitratesAudio$item = item,
                                            height = _bitratesAudio$item.height,
                                            name = _bitratesAudio$item.name;
                                        var level = {
                                            height: height,
                                            id: index.toString(),
                                            label: 'audio ' + parseInt(item.bitrate / 1000)
                                        };
                                        levelsAudio.push(level);
                                    }
                                });
                            }
                        }
                        return [...levels, ...levelsAudio];
                    }
                }, {
                    key: "audioLevels",
                    get: function get() {
                        ...
                        if (__classPrivateFieldGet(this, _player)) {
                            var bitrates = __classPrivateFieldGet(this, _player).getBitrateInfoListFor('audio');
                            if (bitrates.length) {
                                bitrates.forEach(function (item, index) {
                                    if (item) {
                                        var _bitrates$item = item,
                    ...
                    set: function set(level) {
                        if (level === 0) {
                            ...
                            let levels = document.getElementsByClassName("op-settings__submenu-item");
                            let qualityType = 'video';
                            for (var i = 0, total = levels.length; i < total; ++i) {
                                qualityType = levels[i].classList.contains('Audio') ? 'audio' : "video"
                            }

                            if (Number.isInteger(level)) {
                                __classPrivateFieldGet(this, _player).setQualityFor(qualityType, level);
                            }
                        }
                    },
                    get: function get() {
                    ...
                    set: function set(level) {
                        ...
                        if (level === 0) {
                            ...
                            // __classPrivateFieldGet(this, _player).setAutoSwitchQuality(false);
                            __classPrivateFieldGet(this, _player).setQualityFor('audio', level);
                        }
                    },
                    get: function get() {
                        return __classPrivateFieldGet(this, _player) ? __classPrivateFieldGet(this, _player).getQualityFor('audio') : -1;
                    }
                }]);
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var HlsMedia = function (_native_1$default) {
                ...
                function HlsMedia(element, mediaSource) {
                    ...
                    _this.promise = typeof Hls === 'undefined' ? general_1.loadScript('../assets/openplayer/hls.min.js') : new Promise(function (resolve) {
                        resolve({});
                    });
                ...
                _createClass(HlsMedia, [{
                    ...
                    value: function _revoke() {
                        ...
                        if (__classPrivateFieldGet(this, _events) && __classPrivateFieldGet(_this4, _player)) {
                            Object.keys(__classPrivateFieldGet(this, _events)).forEach(function (event) {
                    ...
                    get: function get() {
                        ...
                        if (__classPrivateFieldGet(this, _player) && __classPrivateFieldGet(this, _player).levels && __classPrivateFieldGet(this, _player).levels.length) {
                            ...
                            Object.keys(__classPrivateFieldGet(this, _player).levels).forEach(function (item) {
                                ...
                                var level = {
                                    height: height,
                                    id: item,
                                    label: height.toString() || null
                                };
                                levels.push(level);
                            });
                        }
                        // if (__classPrivateFieldGet(this, _player) && __classPrivateFieldGet(this, _player).audioTracks && __classPrivateFieldGet(this, _player).audioTracks.length) {
                        //
                        //     Object.keys(__classPrivateFieldGet(this, _player).audioTracks).forEach(function (item) {
                        //         var audioTracks = __classPrivateFieldGet(_this6, _player).audioTracks[item],
                        //             height = audioTracks.audioCodec,
                        //             name = audioTracks.name.split('_').join(' ');
                        //         var level = {
                        //             height: height,
                        //             id: item,
                        //             label: name || null
                        //         };
                        //         levels.push(level);
                        //             console.log("Object.keys(__classPrivateFieldGet(this, _player).audioTracks)", audioTracks)
                        //
                        //     });
                        // }
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _adsEnded, _adsDone, _adsActive, _adsStarted, _intervalTimer, _adsVolume, _adsMuted, _adsDuration,
                _adsCurrentTime, _adsManager, _player, _media, _element, _events, _ads, _promise, _adsLoader,
                _adsContainer, _adDisplayContainer, _adsRequest, _autoStart, _autoStartMuted, _playTriggered,
                _adsOptions, _currentAdsIndex, _originalVolume, _preloadContent, _lastTimePaused, _mediaSources,
                _mediaStarted;
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            var _AudioPlayer, _button, _menu, _events, _detachMenu, _labels, _audioLevels, _default, _position,
                _layer;
            ...
            var LevelsAudio = function () {
                function LevelsAudio(player, position, layer) {
                    _classCallCheck(this, LevelsAudio);

                    _AudioPlayer.set(this, void 0);
                    ...
                    __classPrivateFieldSet(this, _AudioPlayer, player);
                ...
                _createClass(LevelsAudio, [{
                    key: "create",
                    value: function create() {
                        var _this = this;

                        // var initialLevel = __classPrivateFieldGet(this, _AudioPlayer).getOptions().defaultLevel !== null ? parseInt(__classPrivateFieldGet(this, _AudioPlayer).getOptions().defaultLevel, 10) : __classPrivateFieldGet(this, _AudioPlayer).getMedia().level;
                        var initialLevel = -1;
                        __classPrivateFieldSet(this, _default, "".concat(initialLevel));
                        ...
                        __classPrivateFieldGet(this, _button).tabIndex = 0;
                        __classPrivateFieldGet(this, _button).title = __classPrivateFieldGet(this, _labels).mediaLevels;
                        __classPrivateFieldGet(this, _button).setAttribute('aria-controls', __classPrivateFieldGet(this, _AudioPlayer).id);
                        __classPrivateFieldGet(this, _button).setAttribute('aria-label', __classPrivateFieldGet(this, _labels).mediaLevels);
                        ...
                        var loadLevelsEvent = function loadLevelsEvent() {
                            if (!__classPrivateFieldGet(_this, _audioLevels).length) {
                                _this._gatherLevels.bind(_this);

                                setTimeout(function () {

                                    __classPrivateFieldGet(_this, _AudioPlayer).getMedia().level = initialLevel;
                                    var e = events_1.addEvent('controlschanged');

                                    __classPrivateFieldGet(_this, _AudioPlayer).getElement().dispatchEvent(e);
                                }, 0);
                            } else if (!levelSet) {
                                __classPrivateFieldGet(_this, _AudioPlayer).getMedia().level = initialLevel;
                                levelSet = true;
                        ...
                        if (__classPrivateFieldGet(this, _detachMenu)) {
                            ...
                            __classPrivateFieldGet(this, _events).button.click = function () {
                                if (__classPrivateFieldGet(_this, _detachMenu)) {
                                    var menus = __classPrivateFieldGet(_this, _AudioPlayer).getContainer().querySelectorAll('.op-settings');
                            ...
                            __classPrivateFieldGet(this, _AudioPlayer).getElement().addEventListener('controlshidden', __classPrivateFieldGet(this, _events).button.mouseout, constants_1.EVENT_OPTIONS);
                        }

                        __classPrivateFieldGet(this, _events).global.click = function (e) {
                            var option = e.target;

                            var currentTime = __classPrivateFieldGet(_this, _AudioPlayer).getMedia().currentTime;

                            var isPaused = __classPrivateFieldGet(_this, _AudioPlayer).getMedia().paused;

                            if (option.closest("#".concat(__classPrivateFieldGet(_this, _AudioPlayer).id)) && general_1.hasClass(option, 'op-audio-levels__option')) {
                                var levelVal = option.getAttribute('data-value');
                                var level = parseInt(levelVal ? levelVal.replace('audioLevels-', '') : '-1', 10);
                                ...
                                __classPrivateFieldGet(_this, _AudioPlayer).getMedia().level = level;
                                __classPrivateFieldGet(_this, _AudioPlayer).getMedia().currentTime = currentTime;

                                if (!isPaused) {
                                    __classPrivateFieldGet(_this, _AudioPlayer).play();
                                }
                                ...
                                __classPrivateFieldGet(_this, _AudioPlayer).getElement().dispatchEvent(event);
                        ...
                        __classPrivateFieldGet(this, _events).global.connection = function () {
                            var media = __classPrivateFieldGet(_this, _AudioPlayer).getMedia().current;

                            if (!media_1.isDashSource(media) && !media_1.isHlsSource(media)) {
                                var type = connection.effectiveType;

                                var levels = __classPrivateFieldGet(_this, _audioLevels).map(function (item) {
                                    return Object.assign(Object.assign({}, item), {
                                        resolution: parseInt(item.label.replace('p', ''), 10)
                                    });
                                });
                                ...
                                if (level) {
                                    __classPrivateFieldGet(_this, _AudioPlayer).pause();

                                    __classPrivateFieldGet(_this, _AudioPlayer).getMedia().level = level.id;
                        ...
                        Object.keys(__classPrivateFieldGet(this, _events).media).forEach(function (event) {
                            __classPrivateFieldGet(_this, _AudioPlayer).getElement().addEventListener(event, __classPrivateFieldGet(_this, _events).media[event], constants_1.EVENT_OPTIONS);
                        });
                        document.addEventListener('click', __classPrivateFieldGet(this, _events).global.click, constants_1.EVENT_OPTIONS);
                    ...
                    value: function destroy() {
                        ...
                        var connection = constants_1.NAV.connection || constants_1.NAV.mozConnection || constants_1.NAV.webkitConnection;
                        Object.keys(__classPrivateFieldGet(this, _events).media).forEach(function (event) {
                            __classPrivateFieldGet(_this2, _AudioPlayer).getElement().removeEventListener(event, __classPrivateFieldGet(_this2, _events).media[event]);
                        });
                        document.removeEventListener('click', __classPrivateFieldGet(this, _events).global.click);
                        ...
                        if (__classPrivateFieldGet(this, _detachMenu)) {
                            ...
                            __classPrivateFieldGet(this, _AudioPlayer).getElement().removeEventListener('controlshidden', __classPrivateFieldGet(this, _events).button.mouseout);
                    ...
                    value: function addSettings() {
                        ...
                        return subitems.length > 2 ? {
                            className: 'op-audio-levels__option',
                            "default": __classPrivateFieldGet(this, _default) || '-1',
                            key: 'audioLevels',
                            name: __classPrivateFieldGet(this, _labels).audioLevels,
                            subitems: subitems
                        } : {};
                    }
                }, {
                    ...
                    value: function _gatherLevels() {
                        ...
                        if (!__classPrivateFieldGet(this, _audioLevels).length) {
                            __classPrivateFieldGet(this, _AudioPlayer).getMedia().levels.forEach(function (level) {
                                if (level['label'] && level['label'].startsWith('audio ')) {
                                    __classPrivateFieldGet(_this3, _audioLevels).push(Object.assign(Object.assign({}, level), {
                                        label: level.label.substr(6) || _this3._getResolutionsLabel(level.height)
                                    }));
                                }
                        ...
                        return __classPrivateFieldGet(this, _audioLevels);
                    }
                }, {
                    key: "_buildMenu",
                    value: function _buildMenu() {
                        ...
                        if (__classPrivateFieldGet(this, _detachMenu)) {
                            ...
                            var className = 'op-audio-levels__option';
                            ...
                            __classPrivateFieldGet(this, _AudioPlayer).getControls().getLayer(__classPrivateFieldGet(this, _layer)).appendChild(itemContainer);
                        }
                    }
                }]);
            ...
            _AudioPlayer = new WeakMap(), _button = new WeakMap(), _menu = new WeakMap(), _events = new WeakMap(), _detachMenu = new WeakMap(), _labels = new WeakMap(), _audioLevels = new WeakMap(), _default = new WeakMap(), _position = new WeakMap(), _layer = new WeakMap();
            exports["default"] = LevelsAudio;
